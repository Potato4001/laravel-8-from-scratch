                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-semibold">
                                        <a href="/admin/posts/{{ $post->id }}/edit" 
                                            class="inline-flex text-blue-500 hover:text-blue-800 rounded-full bg-blue-100 px-2"
                                        >
                                        Edit
                                        </a>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <!--<a href="/admin/posts/{{ $post->id }}/edit" class="text-red-500 hover:text-red-800">Delete</a>-->
